            ...
            return html`
              <div class="ap-col-line" style="grid-column:${apCol(i)}; grid-row:3;">
                ${hideApOwnLine || routerOffline
                  ? null
                  : this._verticalSingleLine(busLineColor, 3, animate, 28, false)}
              </div>
            `;
          }
          ...
          if (!col.ap) {
            ...
            return html`
              <div class="ap-col-line" style="grid-column:${apCol(i)}; grid-row:5;">
                ${feederOffline ? null : this._verticalSingleLine(col.switch?.colors?.bus_line || busLineColor, 3, animate, 28, false)}
              </div>
            `;
          }
