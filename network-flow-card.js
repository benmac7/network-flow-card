...
const DEFAULT_CONFIG = {
  ...
  vpn_badge_outline_color: "transparent",
  vpn_badge_size: 18,
    ...
    return html`
      <div class="trunk">
        ...
        >
          ...
          ${router.entities?.vpn && isVpnActive(hass, router.entities.vpn)
            ? html`<div
                class="vpn-badge"
                style="background:${this._config.vpn_badge_color ?? 'var(--blue-color)'}; color:${this._config.vpn_badge_icon_color ?? 'var(--card-background-color)'}; border:2px solid ${this._config.vpn_badge_outline_color ?? 'transparent'}; width:${this._config.vpn_badge_size ?? 18}px; height:${this._config.vpn_badge_size ?? 18}px;"
              >
                <ha-icon icon="${this._config.vpn_badge_icon || 'mdi:vpn'}" style="--mdc-icon-size:${this._config.vpn_badge_icon_size ?? 12}px"></ha-icon>
              </div>`
            : null}
          ${lan.entity
            ? html`
          ...
          ? html`
              ...
              >
                ...
                ${primaryBadgeShowTiered
                  ...
                  : null}
                ${primaryApItem.ap.entities?.vpn && isVpnActive(hass, primaryApItem.ap.entities.vpn)
                  ? html`<div
                      class="vpn-badge"
                      style="background:${this._config.vpn_badge_color ?? 'var(--blue-color)'}; color:${this._config.vpn_badge_icon_color ?? 'var(--card-background-color)'}; border:2px solid ${this._config.vpn_badge_outline_color ?? 'transparent'}; width:${this._config.vpn_badge_size ?? 18}px; height:${this._config.vpn_badge_size ?? 18}px;"
                    >
            ...
            return html`
              ...
              >
                ...
                ${primaryApLayout === "flat" && item.ap.is_primary && primaryBadgeShowFlat
                  ...
                  : null}
                ${item.ap.is_primary && item.ap.entities?.vpn && isVpnActive(hass, item.ap.entities.vpn)
                  ? html`<div
                      class="vpn-badge"
                      style="background:${this._config.vpn_badge_color ?? 'var(--blue-color)'}; color:${this._config.vpn_badge_icon_color ?? 'var(--card-background-color)'}; border:2px solid ${this._config.vpn_badge_outline_color ?? 'transparent'}; width:${this._config.vpn_badge_size ?? 18}px; height:${this._config.vpn_badge_size ?? 18}px;"
                    >
  ...
  _renderRouterPage() {
    ...
    return html`
      <div class="form-section">
        ...
        <ha-entity-picker
          .hass=${this.hass}
          .value=${router.entities?.vpn || ""}
          .label=${"VPN Active Entity (Optional)"}
          @value-changed=${(e) => this._valueChanged(e, "router.entities.vpn")}
          allow-custom-entity
        ></ha-entity-picker>
      ...
      <div class="form-section">
        ...
        ${ap.is_primary
          ? html`
              <ha-entity-picker
                .hass=${this.hass}
                .value=${ap.entities?.vpn || ""}
                .label=${"VPN Active Entity (Optional)"}
                @value-changed=${(e) => this._valueChanged(e, `${prefix}.entities.vpn`)}
                allow-custom-entity
              ></ha-entity-picker>
            `
          : null}
  ...
  _renderAdvancedPage() {
    ...
    return html`
      <div class="form-section">
        ...
        <div class="sub-header">VPN Badge</div>
        <ha-icon-picker
          .label=${"VPN Badge Icon"}
          .value=${this._config.vpn_badge_icon || "mdi:vpn"}
          @value-changed=${(e) => this._valueChanged(e, "vpn_badge_icon")}
        ></ha-icon-picker>
        ${this._renderColorInput("Badge Background", this._config.vpn_badge_color, "vpn_badge_color")}
        ${this._renderColorInput("Badge Icon Color", this._config.vpn_badge_icon_color, "vpn_badge_icon_color")}
        ${this._renderColorInput("Badge Outline Color", this._config.vpn_badge_outline_color, "vpn_badge_outline_color")}
        ${this._renderSlider("Badge Size", this._config.vpn_badge_size, "vpn_badge_size", 12, 40)}
        ${this._renderSlider("Badge Icon Size", this._config.vpn_badge_icon_size, "vpn_badge_icon_size", 8, 28)}
