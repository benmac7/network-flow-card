...
class NetworkFlowCard extends LitElement {
                  ...
                  return html`
                    ...
                    >
                      ...
                      <div class="summary-text">
                        ...
                        <div class="summary-secondary">${vpnOn ? "Connected" : "Disconnected"}</div>
                      </div>
                    </div>
                  `;
                })()
  ...
  static get styles() {
    return css`
      ...
      .vpn-badge-flash {
        animation: nf-vpn-flash 1.2s ease-in-out infinite;
      }
      .icon-pulse {
...
const MENU_ITEMS = [
  ...
  { key: "vpn", title: "VPN", icon: "mdi:vpn", summary: "Entity, target (Router or Primary AP), badge colors" },
...
class NetworkFlowCardEditor extends LitElement {
  ...
  _renderVpnPage() {
    const target = this._config.vpn_target || "router";
    ...
    return html`
      <div class="form-section">
        ...
        ${target === "primary_ap" && !hasPrimaryAp
          ? html`
        ...
        <div class="toggle-row">
          ...
          <ha-switch
            .checked=${this._config.vpn_show_summary ?? false}
            @change=${(e) => this._valueChanged(e, "vpn_show_summary")}
          ></ha-switch>
        </div>

        <div class="sub-header">Badge Appearance</div>
        <ha-icon-picker
          .label=${"Icon"}
