...
const DEFAULT_CONFIG = {
  ...
  individual_devices_group_layout: "gaps",
  show_summary: true,
  animation: true,
...
class NetworkFlowCard extends LitElement {
  ...
  _renderIndividualDevices(devices, hass, config, animate, minDur, maxDur, apCount) {
    ...
    const groupLayout = config.individual_devices_group_layout || "gaps";
        ...
        ${this._config.individual_devices_group_by && this._config.individual_devices_group_by !== "none"
          ? html`
              <div class="select-field">
                ...
                <select
                  class="native-select"
                  .value=${this._config.individual_devices_group_layout || "gaps"}
