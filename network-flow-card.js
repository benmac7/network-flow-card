  ...
  _renderChildLists(holderPath, holder, noun = "Switch") {
    ...
    return b`
      ...
      ${this._infoHeader(
        "Fed Switches",
        noun === "Switch"
          ? "Switches added here hang off this Switch too, in the same row as its Access Points. A fed Switch can feed its own Access Points, Switches and Homelabs in turn, to any depth."
          : "Switches added here hang off this Access Point, in the row below it. A fed Switch can feed its own Access Points, Switches and Homelabs in turn, to any depth."
      )}
      ${feds.map((sw, i) => b`
        <div class="list-item">
          <div class="list-item-info">
      ...
      ${this._infoHeader(
        "Homelab Servers",
        `Homelab servers added here hang off this ${noun} too. Each keeps its own Containers/VMs, PoE and Connected Devices, and shows any Security badges targeted at Homelab.`
      )}
      ${homelabs.map((hl, i) => b`
        <div class="list-item">
          <div class="list-item-info">
