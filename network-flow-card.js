...
class NetworkFlowCardEditor extends i {
    ...
    return b`
      <div class="form-section">
        ...
        <p style="color:var(--secondary-text-color); font-size:0.9em; margin:0 0 8px 0;">
          ...
          nodes) and Proxmox VE (physical/cluster nodes, added as
          Homelab Server nodes with their VMs/Containers attached
          automatically) in one pass. Nothing is added automatically;
          filter and select which ones you want below.
        </p>
  ...
  _scanForNodes() {
    ...
    this._discoveredNodesFilterSource = "";
    this._discoveredNodesFilterType = "";
    this._nodeScanMessage = candidates.length ? "" : "No TP-Link Deco satellite units or Proxmox VE nodes found.";
    this.requestUpdate();
  }
  ...
  _renderDiscoveredNodesList() {
    ...
    const sourceLabel = { tplink_deco: "TP-Link Deco", proxmoxve: "Proxmox VE" };
