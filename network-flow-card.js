...
let n$2 = class n {
    constructor(t, e, o) { if (this._$cssResult$ = true, o !== s$2)
        throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead."); this.cssText = t, this.t = e; }
    get styleSheet() { let t = this.o; const s = this.t; if (e$2 && void 0 === t) {
...
const r$2 = t => new n$2("string" == typeof t ? t : t + "", void 0, s$2), i$3 = (t, ...e) => { const o = 1 === t.length ? t[0] : e.reduce((e, s, o) => e + (t => { if (true === t._$cssResult$)
    return t.cssText; if ("number" == typeof t)
    return t; throw Error("Value passed to 'css' function must be a 'css' function result: " + t + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security."); })(s) + t[o + 1], t[0]); return new n$2(o, t, s$2); }, S$1 = (s, o) => { if (e$2)
    ...
    } }, c$2 = e$2 ? t => t : t => t instanceof CSSStyleSheet ? (t => { let e = ""; for (const s of t.cssRules)
    e += s.cssText; return r$2(e); })(t) : t;
const { is: i$2, defineProperty: e$1, getOwnPropertyDescriptor: h$1, getOwnPropertyNames: r$1, getOwnPropertySymbols: o$2, getPrototypeOf: n$1 } = Object, a$1 = globalThis, c$1 = a$1.trustedTypes, l$1 = c$1 ? c$1.emptyScript : "", p$1 = a$1.reactiveElementPolyfillSupport, d$1 = (t, s) => t, u$1 = { toAttribute(t, s) { switch (s) {
        case Boolean:
            t = t ? l$1 : null;
            break;
        case Object:
        case Array: t = null == t ? t : JSON.stringify(t);
    } return t; }, fromAttribute(t, s) { let i = t; switch (s) {
        case Boolean:
            i = null !== t;
            break;
        case Number:
    ...
    } return i; } }, f$1 = (t, s) => !i$2(t, s), b$1 = { attribute: true, type: String, converter: u$1, reflect: false, useDefault: false, hasChanged: f$1 };
...
let y$1 = class y extends HTMLElement {
    ...
    static createProperty(t, s = b$1) { if (s.state && (s.attribute = false), this._$Ei(), this.prototype.hasOwnProperty(t) && ((s = Object.create(s)).wrapped = true), this.elementProperties.set(t, s), !s.noAccessor) {
        const i = Symbol(), h = this.getPropertyDescriptor(t, i, s);
        void 0 !== h && e$1(this.prototype, t, h);
    } }
    static getPropertyDescriptor(t, s, i) { const { get: e, set: r } = h$1(this.prototype, t) ?? { get() { return this[s]; }, set(t) { this[s] = t; } }; return { get: e, set(s) { const h = e?.call(this); r?.call(this, s), this.requestUpdate(t, h, i); }, configurable: true, enumerable: true }; }
    static getPropertyOptions(t) { return this.elementProperties.get(t) ?? b$1; }
    static _$Ei() { if (this.hasOwnProperty(d$1("elementProperties")))
        return; const t = n$1(this); t.finalize(), void 0 !== t.l && (this.l = [...t.l]), this.elementProperties = new Map(t.elementProperties); }
    static finalize() { if (this.hasOwnProperty(d$1("finalized")))
        return; if (this.finalized = true, this._$Ei(), this.hasOwnProperty(d$1("properties"))) {
        const t = this.properties, s = [...r$1(t), ...o$2(t)];
        for (const i of s)
            this.createProperty(i, t[i]);
    } const t = this[Symbol.metadata]; if (null !== t) {
        const s = litPropertyMetadata.get(t);
        if (void 0 !== s)
            for (const [t, i] of s)
                this.elementProperties.set(t, i);
    } this._$Eh = new Map; for (const [t, s] of this.elementProperties) {
        const i = this._$Eu(t, s);
        void 0 !== i && this._$Eh.set(i, t);
    } this.elementStyles = this.finalizeStyles(this.styles); }
    static finalizeStyles(s) { const i = []; if (Array.isArray(s)) {
        const e = new Set(s.flat(1 / 0).reverse());
        for (const s of e)
            i.unshift(c$2(s));
    }
    else
        void 0 !== s && i.push(c$2(s)); return i; }
    static _$Eu(t, s) { const i = s.attribute; return false === i ? void 0 : "string" == typeof i ? i : "string" == typeof t ? t.toLowerCase() : void 0; }
    ...
    _$E_() { const t = new Map, s = this.constructor.elementProperties; for (const i of s.keys())
        this.hasOwnProperty(i) && (t.set(i, this[i]), delete this[i]); t.size > 0 && (this._$Ep = t); }
    createRenderRoot() { const t = this.shadowRoot ?? this.attachShadow(this.constructor.shadowRootOptions); return S$1(t, this.constructor.elementStyles), t; }
    connectedCallback() { this.renderRoot ??= this.createRenderRoot(), this.enableUpdating(true), this._$EO?.forEach(t => t.hostConnected?.()); }
    enableUpdating(t) { }
    disconnectedCallback() { this._$EO?.forEach(t => t.hostDisconnected?.()); }
    attributeChangedCallback(t, s, i) { this._$AK(t, i); }
    _$ET(t, s) { const i = this.constructor.elementProperties.get(t), e = this.constructor._$Eu(t, i); if (void 0 !== e && true === i.reflect) {
        const h = (void 0 !== i.converter?.toAttribute ? i.converter : u$1).toAttribute(s, i.type);
        this._$Em = t, null == h ? this.removeAttribute(e) : this.setAttribute(e, h), this._$Em = null;
    } }
    _$AK(t, s) { const i = this.constructor, e = i._$Eh.get(t); if (void 0 !== e && this._$Em !== e) {
    ...
    requestUpdate(t, s, i, e = false, h) { if (void 0 !== t) {
        const r = this.constructor;
        if (false === e && (h = this[t]), i ??= r.getPropertyOptions(t), !((i.hasChanged ?? f$1)(h, s) || i.useDefault && i.reflect && h === this._$Ej?.get(t) && !this.hasAttribute(r._$Eu(t, i))))
            return;
        this.C(t, s, i);
    } false === this.isUpdatePending && (this._$ES = this._$EP()); }
    C(t, s, { useDefault: i, reflect: e, wrapped: h }, r) { i && !(this._$Ej ??= new Map).has(t) && (this._$Ej.set(t, r ?? s ?? this[t]), true !== h || void 0 !== r) || (this._$AL.has(t) || (this.hasUpdated || i || (s = void 0), this._$AL.set(t, s)), true === e && this._$Em !== t && (this._$Eq ??= new Set).add(t)); }
    async _$EP() { this.isUpdatePending = true; try {
        await this._$ES;
    }
    catch (t) {
        Promise.reject(t);
    ...
    performUpdate() { if (!this.isUpdatePending)
        return; if (!this.hasUpdated) {
    ...
    } let t = false; const s = this._$AL; try {
    ...
    willUpdate(t) { }
    _$AE(t) { this._$EO?.forEach(t => t.hostUpdated?.()), this.hasUpdated || (this.hasUpdated = true, this.firstUpdated(t)), this.updated(t); }
    _$EM() { this._$AL = new Map, this.isUpdatePending = false; }
    get updateComplete() { return this.getUpdateComplete(); }
    getUpdateComplete() { return this._$ES; }
    shouldUpdate(t) { return true; }
...
const t = globalThis, i$1 = t => t, s$1 = t.trustedTypes, e = s$1 ? s$1.createPolicy("lit-html", { createHTML: t => t }) : void 0, h = "$lit$", o$1 = `lit$${Math.random().toFixed(9).slice(2)}$`, n = "?" + o$1, r = `<${n}>`, l = document, c = () => l.createComment(""), a = t => null === t || "object" != typeof t && "function" != typeof t, u = Array.isArray, d = t => u(t) || "function" == typeof t?.[Symbol.iterator], f = "[ \t\n\f\r]", v = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, _ = /-->/g, m = />/g, p = RegExp(`>|${f}(?:([^\\s"'>=/]+)(${f}*=${f}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), g = /'/g, $ = /"/g, y = /^(?:script|style|textarea|title)$/i, x = t => (i, ...s) => ({ _$litType$: t, strings: i, values: s }), b = x(1), w = x(2), E = Symbol.for("lit-noChange"), A = Symbol.for("lit-nothing"), C = new WeakMap, P = l.createTreeWalker(l, 129);
function V(t, i) { if (!u(t) || !t.hasOwnProperty("raw"))
    throw Error("invalid template strings array"); return void 0 !== e ? e.createHTML(i) : i; }
const N = (t, i) => { const s = t.length - 1, e = []; let n, l = 2 === i ? "<svg>" : 3 === i ? "<math>" : "", c = v; for (let i = 0; i < s; i++) {
    const s = t[i];
    let a, u, d = -1, f = 0;
    for (; f < s.length && (c.lastIndex = f, u = c.exec(s), null !== u);)
        f = c.lastIndex, c === v ? "!--" === u[1] ? c = _ : void 0 !== u[1] ? c = m : void 0 !== u[2] ? (y.test(u[2]) && (n = RegExp("</" + u[2], "g")), c = p) : void 0 !== u[3] && (c = p) : c === p ? ">" === u[0] ? (c = n ?? v, d = -1) : void 0 === u[1] ? d = -2 : (d = c.lastIndex - u[2].length, a = u[1], c = void 0 === u[3] ? p : '"' === u[3] ? $ : g) : c === $ || c === g ? c = p : c === _ || c === m ? c = v : (c = p, n = void 0);
    const x = c === p && t[i + 1].startsWith("/>") ? " " : "";
    l += c === v ? s + r : d >= 0 ? (e.push(a), s.slice(0, d) + h + s.slice(d) + o$1 + x) : s + o$1 + (-2 === d ? i : x);
} return [V(t, l + (t[s] || "<?>") + (2 === i ? "</svg>" : 3 === i ? "</math>" : "")), e]; };
class S {
    constructor({ strings: t, _$litType$: i }, e) { let r; this.parts = []; let l = 0, a = 0; const u = t.length - 1, d = this.parts, [f, v] = N(t, i); if (this.el = S.createElement(f, e), P.currentNode = this.el.content, 2 === i || 3 === i) {
        ...
        if (1 === r.nodeType) {
            if (r.hasAttributes())
                for (const t of r.getAttributeNames())
                    if (t.endsWith(h)) {
                        ...
                        t.startsWith(o$1) && (d.push({ type: 6, index: l }), r.removeAttribute(t));
            if (y.test(r.tagName)) {
                const t = r.textContent.split(o$1), i = t.length - 1;
                if (i > 0) {
                    r.textContent = s$1 ? s$1.emptyScript : "";
                    for (let s = 0; s < i; s++)
                        r.append(t[s], c()), P.nextNode(), d.push({ type: 2, index: ++l });
                    r.append(t[i], c());
                }
            }
        }
            ...
            if (r.data === n)
                ...
                for (; -1 !== (t = r.data.indexOf(o$1, t + 1));)
                    d.push({ type: 7, index: l }), t += o$1.length - 1;
            }
        l++;
    } }
    static createElement(t, i) { const s = l.createElement("template"); return s.innerHTML = t, s; }
}
function M(t, i, s = t, e) { if (i === E)
    return i; let h = void 0 !== e ? s._$Co?.[e] : s._$Cl; const o = a(i) ? void 0 : i._$litDirective$; return h?.constructor !== o && (h?._$AO?.(false), void 0 === o ? h = void 0 : (h = new o(t), h._$AT(t, s, e)), void 0 !== e ? (s._$Co ??= [])[e] = h : s._$Cl = h), void 0 !== h && (i = M(t, h._$AS(t, i.values), h, e)), i; }
class R {
    ...
    u(t) { const { el: { content: i }, parts: s } = this._$AD, e = (t?.creationScope ?? l).importNode(i, true); P.currentNode = e; let h = P.nextNode(), o = 0, n = 0, r = s[0]; for (; void 0 !== r;) {
        if (o === r.index) {
            let i;
...
class k {
    ...
    constructor(t, i, s, e) { this.type = 2, this._$AH = A, this._$AN = void 0, this._$AA = t, this._$AB = i, this._$AM = s, this.options = e, this._$Cv = e?.isConnected ?? true; }
    ...
    _$AI(t, i = this) { t = M(this, t, i), a(t) ? t === A || null == t || "" === t ? (this._$AH !== A && this._$AR(), this._$AH = A) : t !== this._$AH && t !== E && this._(t) : void 0 !== t._$litType$ ? this.$(t) : void 0 !== t.nodeType ? this.T(t) : d(t) ? this.k(t) : this._(t); }
    O(t) { return this._$AA.parentNode.insertBefore(t, this._$AB); }
    T(t) { this._$AH !== t && (this._$AR(), this._$AH = this.O(t)); }
    _(t) { this._$AH !== A && a(this._$AH) ? this._$AA.nextSibling.data = t : this.T(l.createTextNode(t)), this._$AH = t; }
    $(t) { const { values: i, _$litType$: s } = t, e = "number" == typeof s ? this._$AC(t) : (void 0 === s.el && (s.el = S.createElement(V(s.h, s.h[0]), this.options)), s); if (this._$AH?._$AD === e)
        this._$AH.p(i);
    else {
        const t = new R(e, this), s = t.u(this.options);
        t.p(i), this.T(s), this._$AH = t;
    } }
    _$AC(t) { let i = C.get(t.strings); return void 0 === i && C.set(t.strings, i = new S(t)), i; }
    k(t) { u(this._$AH) || (this._$AH = [], this._$AR()); const i = this._$AH; let s, e = 0; for (const h of t)
        e === i.length ? i.push(s = new k(this.O(c()), this.O(c()), this, this.options)) : s = i[e], s._$AI(h), e++; e < i.length && (this._$AR(s && s._$AB.nextSibling, e), i.length = e); }
    _$AR(t = this._$AA.nextSibling, s) { for (this._$AP?.(false, true, s); t !== this._$AB;) {
...
class H {
    ...
    get _$AU() { return this._$AM._$AU; }
    constructor(t, i, s, e, h) { this.type = 1, this._$AH = A, this._$AN = void 0, this.element = t, this.name = i, this._$AM = e, this.options = h, s.length > 2 || "" !== s[0] || "" !== s[1] ? (this._$AH = Array(s.length - 1).fill(new String), this.strings = s) : this._$AH = A; }
    _$AI(t, i = this, s, e) { const h = this.strings; let o = false; if (void 0 === h)
        t = M(this, t, i, 0), o = !a(t) || t !== this._$AH && t !== E, o && (this._$AH = t);
    else {
        const e = t;
        let n, r;
        for (t = h[0], n = 0; n < h.length - 1; n++)
            r = M(this, e[s + n], i, n), r === E && (r = this._$AH[n]), o ||= !a(r) || r !== this._$AH[n], r === A ? t = A : t !== A && (t += (r ?? "") + h[n + 1]), this._$AH[n] = r;
    } o && !e && this.j(t); }
    j(t) { t === A ? this.element.removeAttribute(this.name) : this.element.setAttribute(this.name, t ?? ""); }
}
class I extends H {
    constructor() { super(...arguments), this.type = 3; }
    j(t) { this.element[this.name] = t === A ? void 0 : t; }
}
class L extends H {
    constructor() { super(...arguments), this.type = 4; }
    j(t) { this.element.toggleAttribute(this.name, !!t && t !== A); }
}
class z extends H {
    constructor(t, i, s, e, h) { super(t, i, s, e, h), this.type = 5; }
    _$AI(t, i = this) { if ((t = M(this, t, i, 0) ?? A) === E)
        return; const s = this._$AH, e = t === A && s !== A || t.capture !== s.capture || t.once !== s.once || t.passive !== s.passive, h = t !== A && (s === A || e); e && this.element.removeEventListener(this.name, this, s), h && this.element.addEventListener(this.name, this, t), this._$AH = t; }
...
const D = (t, i, s) => { const e = s?.renderBefore ?? i; let h = e._$litPart$; if (void 0 === h) {
...
class i extends y$1 {
    ...
    update(t) { const r = this.render(); this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = D(r, this.renderRoot, this.renderOptions); }
    connectedCallback() { super.connectedCallback(), this._$Do?.setConnected(true); }
    disconnectedCallback() { super.disconnectedCallback(), this._$Do?.setConnected(false); }
    render() { return E; }
}
...
console.info("%c NETWORK-FLOW-CARD %c v3.1.0 ", "color: white; background: #3b82f6; font-weight: 700;", "color: #3b82f6; background: white; font-weight: 700;");
...
function migrateAccessPointsToNodes(config) {
    ...
    if (config.nodes)
        return config;
    if (!config.access_points || !config.access_points.length)
        return config;
...
function setPathValue(obj, path, value) {
    ...
    if (UNSAFE_OBJECT_KEYS.has(lastKey))
        return newObj;
    current[lastKey] = value;
    return newObj;
}
const ENTITY_STATE_CACHE = new WeakMap();
const LIT_NO_CHANGE = Symbol.for("lit-noChange");
...
function getEntityState(hass, entityId) {
    ...
    const parsed = {
        ...
        display: Number.isNaN(numValue) ? stateObj.state : formatNumber(numValue),
...
function getCircleLabel(customName, entityState, fallback) {
    if (customName != null && customName !== "")
        return customName;
    if (entityState)
        return entityState.display || entityState.state;
    return fallback;
}
...
function getDeviceGroupName(hass, dev, groupBy) {
    ...
    if (connectionValue === "wired")
        return "Wired";
    if (groupBy === "ssid") {
        if (attrs.is_guest === true)
            return "Guest";
        const ssid = attrs.interface || attrs.essid;
        return ssid ? capitalizeFirst(ssid) : "Unknown";
    }
    if (groupBy === "vlan") {
        if (attrs.vlan != null && attrs.vlan !== "")
            return `VLAN ${attrs.vlan}`;
        if (attrs.is_guest === true)
            return "Guest";
...
function isGuestDevice(hass, entityId) {
    ...
    if (attrs.interface === "guest")
        return true;
    if (attrs.is_guest === true || attrs.is_guest === "true")
        return true;
    if (attrs.guest === true || attrs.guest === "true")
        return true;
    return false;
}
...
function tplinkFindSibling(hass, entityIds, suffixes) {
    ...
    for (const eid of entityIds) {
        ...
        if (key && suffixes.includes(key) && isLive(eid))
            return eid;
    }
    for (const eid of entityIds) {
        if (suffixes.some((s) => eid.endsWith(s)) && isLive(eid))
            return eid;
    }
    return "";
}
...
function scanSpeedtestIntegration(hass) {
    ...
    for (const [entityId, entry] of Object.entries(hass.entities)) {
        if (SPEEDTEST_PLATFORMS.includes(entry.platform))
            byPlatform[entry.platform].push(entityId);
    }
    const deviceEntityMap = tplinkBuildDeviceEntityMap(hass);
    const services = [];
...
function ispFindField(hass, entityIds, hints, { preferDomain } = {}) {
    ...
    for (const pool of pools) {
        for (const eid of pool) {
            const key = hass.entities?.[eid]?.translation_key;
            if (key && hints.includes(key) && hass.states?.[eid])
                return eid;
        }
        for (const eid of pool) {
            const objectId = eid.split(".")[1] || "";
            if (hints.some((h) => objectId.includes(h)) && hass.states?.[eid])
                return eid;
        }
    }
    return "";
...
function ispFindConnected(hass, entityIds) {
    for (const eid of entityIds) {
        if (!eid.startsWith("binary_sensor."))
            continue;
        if (hass.states?.[eid]?.attributes?.device_class === "connectivity")
            return eid;
    }
...
function scanIspIntegration(hass) {
    ...
    for (const [entityId, entry] of Object.entries(hass.entities)) {
        if (ISP_PLATFORMS.includes(entry.platform))
            (byPlatform[entry.platform] ||= []).push(entityId);
    }
    const deviceEntityMap = tplinkBuildDeviceEntityMap(hass);
    const services = [];
...
function scanAdGuardIntegration(hass) {
    ...
    const entityIds = [];
    for (const [entityId, entry] of Object.entries(hass.entities)) {
        if (entry.platform === ADGUARD_PLATFORM)
            entityIds.push(entityId);
    }
    return groupEntitiesByDevice(hass, entityIds).map((group) => {
        const blocked = group.entityIds.find((id) => hass.entities?.[id]?.translation_key === "dns_queries_blocked" && hass.states?.[id]);
        const total = group.entityIds.find((id) => hass.entities?.[id]?.translation_key === "dns_queries" && hass.states?.[id]);
        return {
            deviceId: group.deviceId,
...
function scanProxmoxIntegration(hass) {
    ...
    for (const [entityId, entry] of Object.entries(hass.entities)) {
        if (entry.platform !== PROXMOX_PLATFORM)
            continue;
        if (!entityId.startsWith("binary_sensor.") || entry.translation_key !== "status")
            continue;
...
function scanPortainerContainers(hass) {
    ...
    const containers = [];
    for (const [entityId, entry] of Object.entries(hass.entities)) {
        if (entry.platform !== PORTAINER_PLATFORM)
            continue;
        if (!entityId.startsWith("binary_sensor.") || entry.translation_key !== "status")
            continue;
        if (!hass.states?.[entityId])
...
function scanOpenWrtIntegration(hass) {
    if (!hass?.entities)
        return { routerCandidate: null, clients: [] };
    const trackers = Object.keys(hass.entities).filter((id) => hass.entities[id].platform === LUCI_PLATFORM && id.startsWith("device_tracker.") && hass.states?.[id]);
    if (!trackers.length)
        return { routerCandidate: null, clients: [] };
...
function scanSynologySrmIntegration(hass) {
    if (!hass?.entities)
        return { routerCandidate: null, clients: [] };
    const trackers = Object.keys(hass.entities).filter((id) => hass.entities[id].platform === SYNOLOGY_SRM_PLATFORM && id.startsWith("device_tracker.") && hass.states?.[id]);
    if (!trackers.length)
        return { routerCandidate: null, clients: [] };
    const proxyEntity = trackers.find((id) => hass.states[id].state === "home") || trackers[0];
    return {
...
function scanAsusRouterIntegration(hass) {
    ...
    for (const [entityId, entry] of Object.entries(hass.entities)) {
        if (entry.platform !== ASUSROUTER_PLATFORM)
            continue;
        if (!hass.states?.[entityId])
            continue;
...
const POE_TOTAL_CACHE = new WeakMap();
const POE_RUNTIME_ENTITY_IDS = new Set();
function computePoeTotal(hass, switchEntityId, poeConfig) {
    if (!poeConfig || poeConfig.mode === "off")
        return null;
    let entityIds = [];
    if (poeConfig.mode === "manual") {
        ...
        if (!hass?.entities || !switchEntityId)
            return null;
        if (POE_AUTO_ENTITY_CACHE.has(switchEntityId)) {
            ...
            entityIds = Object.entries(hass.entities)
                ...
                if (!state || state.attributes?.unit_of_measurement !== "W")
                    return false;
        ...
        for (const id of entityIds)
            POE_RUNTIME_ENTITY_IDS.add(id);
    }
    if (!entityIds.length)
        return null;
    const stateObjs = entityIds.map((id) => hass?.states?.[id] || null);
    const cached = POE_TOTAL_CACHE.get(poeConfig);
    if (cached &&
        cached.switchEntityId === switchEntityId &&
        cached.stateObjs.length === stateObjs.length &&
        cached.stateObjs.every((obj, i) => obj === stateObjs[i])) {
        return cached.total;
    }
    let total = 0;
    let hasValue = false;
    ...
    const result = hasValue ? total : null;
    POE_TOTAL_CACHE.set(poeConfig, { switchEntityId, stateObjs, total: result });
    return result;
}
function computeDiagramPoeTotal(hass, config) {
    const switches = [];
    if (config.switch?.poe && config.switch.poe.mode !== "off")
        switches.push(config.switch);
    if (config.router?.poe && config.router.poe.mode !== "off")
        switches.push(config.router);
    (config.nodes || []).forEach((node) => {
        if (node.switch?.poe && node.switch.poe.mode !== "off")
            switches.push(node.switch);
        if (node.homelab?.poe && node.homelab.poe.mode !== "off")
            switches.push(node.homelab);
        (node.access_points || []).forEach((ap) => {
            if (ap.poe && ap.poe.mode !== "off")
                switches.push(ap);
        });
        (node.fed_switches || []).forEach((sw) => {
            if (sw.poe && sw.poe.mode !== "off")
                switches.push(sw);
        });
    });
    let total = 0;
...
function calcFlowDuration(rate, minDuration, maxDuration) {
    ...
    if (!rate || rate <= 0)
        return clampAndQuantize(maxDuration);
...
class NetworkFlowCard extends i {
    ...
    constructor() {
        ...
        this._alignRaf = null;
        this._trunkEntityIds = new Set();
        this._branchEntityIds = new Set();
        this._clientEntityIds = new Set();
        this._dirtyTrunk = true;
        this._dirtyBranches = true;
        this._dirtyClients = true;
        this._hasRenderedTrunk = false;
        this._hasRenderedBranches = false;
        this._hasRenderedClients = false;
        this._lastLiveRenderAt = 0;
        this._liveRenderTimer = null;
        this._clientGroupCache = null;
    }
    ...
    setConfig(config) {
        ...
        merged.nodes = (migrated.nodes || []).map((node) => {
            ...
            if (mergedNode.homelab) {
                mergedNode.homelab.containers = (node.homelab?.containers || []).map((c) => deepMerge(DEFAULT_CONTAINER_BADGE, c));
            }
            mergedNode.access_points = (node.access_points || []).map((ap) => deepMerge(DEFAULT_ACCESS_POINT, ap));
            mergedNode.fed_switches = (node.fed_switches || []).map((sw) => deepMerge(DEFAULT_NODE_SWITCH, sw));
            return mergedNode;
        });
        merged.individual_devices = (config.individual_devices || []).map((dev) => deepMerge(DEFAULT_INDIVIDUAL_DEVICE, dev));
        this._config = merged;
        this._trackedEntityIds = collectEntityIdsFromConfig(merged);
        this._topology = buildNetworkTopology(merged);
        this._rebuildSectionEntityIds(merged);
        this._markAllSectionsDirty();
        this._clientGroupCache = null;
        this.toggleAttribute("animations-disabled", merged.enable_animations !== true);
    }
    _rebuildSectionEntityIds(config) {
        const topology = this._topology || buildNetworkTopology(config);
        const addIds = (target, value) => {
            for (const id of collectEntityIdsFromConfig(value))
                target.add(id);
        };
        this._clientEntityIds = collectEntityIdsFromConfig(config.individual_devices || []);
        this._branchEntityIds = collectEntityIdsFromConfig(topology.branchColumns || []);
        addIds(this._branchEntityIds, config.router?.entity);
        addIds(this._branchEntityIds, config.switch?.entity);
        if (topology.primaryAp) {
            addIds(this._branchEntityIds, topology.primaryAp.entity);
            addIds(this._branchEntityIds, topology.primaryAp.entities?.connected_devices);
        }
        addIds(this._branchEntityIds, config.vpn_entity);
        addIds(this._branchEntityIds, config.firewall_entity);
        addIds(this._branchEntityIds, config.dns_entity);
        addIds(this._branchEntityIds, config.reverse_proxy_entity);
        this._trunkEntityIds = new Set();
        addIds(this._trunkEntityIds, config.internet);
        addIds(this._trunkEntityIds, config.lan);
        addIds(this._trunkEntityIds, config.router);
        addIds(this._trunkEntityIds, config.switch);
        addIds(this._trunkEntityIds, topology.primaryAp);
        addIds(this._trunkEntityIds, config.vpn_entity);
        addIds(this._trunkEntityIds, config.firewall_entity);
        addIds(this._trunkEntityIds, config.dns_entity);
        addIds(this._trunkEntityIds, config.reverse_proxy_entity);
        if ((config.summary_items || []).includes("poe")) {
            addIds(this._trunkEntityIds, config.router?.poe);
            addIds(this._trunkEntityIds, config.switch?.poe);
            for (const node of config.nodes || []) {
                addIds(this._trunkEntityIds, node.switch?.poe);
                addIds(this._trunkEntityIds, node.homelab?.poe);
                for (const ap of node.access_points || [])
                    addIds(this._trunkEntityIds, ap.poe);
                for (const sw of node.fed_switches || [])
                    addIds(this._trunkEntityIds, sw.poe);
            }
        }
    }
    _markAllSectionsDirty() {
        this._dirtyTrunk = true;
        this._dirtyBranches = true;
        this._dirtyClients = true;
    }
    _markDirtyForEntity(id) {
        let matched = false;
        if (this._trunkEntityIds.has(id)) {
            this._dirtyTrunk = true;
            matched = true;
        }
        if (this._branchEntityIds.has(id)) {
            this._dirtyBranches = true;
            matched = true;
        }
        if (this._clientEntityIds.has(id)) {
            this._dirtyClients = true;
            matched = true;
        }
        if (!matched)
    ...
    _scheduleLiveRender(delayMs) {
        if (this._liveRenderTimer != null)
            return;
        this._liveRenderTimer = setTimeout(() => {
            this._liveRenderTimer = null;
            if (!this._isVisible || !this.isConnected)
                return;
            this._lastLiveRenderAt = typeof performance !== "undefined" ? performance.now() : Date.now();
            this.requestUpdate();
        }, Math.max(0, delayMs));
    }
    shouldUpdate(changedProps) {
        ...
        for (const id of this._trackedEntityIds) {
            if (oldHass.states[id] !== this.hass.states[id]) {
                changed = true;
                this._markDirtyForEntity(id);
            }
        }
        for (const id of POE_RUNTIME_ENTITY_IDS) {
            if (oldHass.states[id] !== this.hass.states[id]) {
                changed = true;
                this._dirtyTrunk = true;
                this._dirtyBranches = true;
        ...
        const elapsed = now - this._lastLiveRenderAt;
        if (this._lastLiveRenderAt && elapsed < LIVE_RENDER_INTERVAL_MS) {
            this._scheduleLiveRender(LIVE_RENDER_INTERVAL_MS - elapsed);
            return false;
        }
        if (this._liveRenderTimer != null) {
            clearTimeout(this._liveRenderTimer);
    ...
    _scheduleAlignBusLine() {
        if (!this._isVisible || this._alignRaf != null)
            return;
    ...
    _alignBusLine() {
        ...
        const isWideWrapper = (el) => el.classList.contains("ap-col-fillline-wrap") || el.classList.contains("bus-top-connector");
        let candidates = Array.from(branches.querySelectorAll(".bus-top-connector .vline, .bus-top-connector .vline-offline, .bus-top-connector .offline-x-mid, .ap-col-fillline-wrap"));
        if (candidates.length < 2) {
            candidates = Array.from(branches.querySelectorAll(".bus-top-connector, .ap-col-fillline-wrap"));
        }
        if (candidates.length < 2)
            return;
        ...
        const trunkCircles = trunkEl
            ? Array.from(trunkEl.querySelectorAll(":scope > .circle-wrap, :scope > .internet-row > .circle-wrap"))
            : [];
    ...
    _renderPrimaryApBadge(ap, stackIndex = 0) {
        if (ap.show_primary_badge === false)
            return null;
    ...
    _renderVpnBadge(hass, entityId, stackIndex = 0) {
        ...
        const flashClass = this._config.enable_animations === true && !vpnOn && cfg.vpn_animate_offline ? "vpn-badge-flash" : "";
        const size = cfg.badge_size ?? 18;
    ...
    _renderFirewallBadge(hass, entityId, stackIndex = 0) {
        ...
        const flashClass = this._config.enable_animations === true && !fwOn && cfg.firewall_animate_offline ? "firewall-badge-flash" : "";
        const size = cfg.badge_size ?? 18;
    ...
    _renderPoeBadge(hass, switchEntityId, poeConfig, stackIndex = 0) {
        ...
        const flashClass = this._config.enable_animations === true && poeConfig.animate_over_threshold && isAbovePoeTopThreshold(total, poeConfig)
            ? "poe-badge-flash"
            : "";
    ...
    _renderIpBadge(hass, entityId, position, ownerCfg) {
        if (!this._config.show_ip_addressing)
            return null;
        if (!entityId)
            return null;
        const stateObj = hass?.states?.[entityId];
    ...
    _renderDnsBadge(hass, stackIndex = 0) {
        ...
        if (isNumeric) {
            ...
            const hPad = Math.round(badgeSize * 0.35);
            const flashClass = this._config.enable_animations === true && cfg.dns_animate_over_threshold && isAbovePoeTopThreshold(val, thresholdCfg) ? "poe-badge-flash" : "";
            return b `<div
        class="poe-badge ${flashClass}"
        style="${posStyle} background:${bg}; color:${textColor}; height:${badgeSize}px; line-height:${badgeSize}px; padding:0 ${hPad}px; gap:${Math.round(badgeSize * 0.2)}px; border-radius:${Math.round(badgeSize / 2)}px; font-size:${fontSize}px;"
      >
    ...
    _renderReverseProxyBadge(hass, stackIndex = 0) {
        ...
        const flashClass = this._config.enable_animations === true && !isUp && cfg.reverse_proxy_animate_offline ? "vpn-badge-flash" : "";
        const size = cfg.badge_size ?? 18;
    ...
    _renderContainerBadge(hass, containerCfg, stackIndex = 0) {
        if (!containerCfg || !containerCfg.entity)
            return null;
        ...
        const flashClass = this._config.enable_animations === true && !isUp && containerCfg.animate_offline ? "vpn-badge-flash" : "";
    ...
    _renderGuestBadge(hass, entityId, online) {
        if (!online)
            return null;
        if (!isGuestDevice(hass, entityId))
            return null;
    ...
    _renderSummaryItem(key, config, hass, ctx) {
      ...
      `;
        ...
        if (key === "poe") {
            ...
            if (total == null)
                return null;
            const bg = config.summary_poe_color_mode === "threshold"
    ...
    _buildPrimaryApRuntime(hass, primaryAp, minDur, maxDur) {
        if (!primaryAp)
            return null;
    ...
    _renderSummarySection(config, hass) {
    ...
    _renderTrunkSection(config, hass, topology) {
        ...
        const hasBilling = internet.entities.billing_total &&
        ...
        const primaryApItem = this._buildPrimaryApRuntime(hass, topology.primaryAp, minDur, maxDur);
        return this._renderTrunk(internet, internetState, lan, lanState, lanDur, pingState, hasBilling, billingCompletedRatio, dlDur, ulDur, animate, router, routerEntityState, routerStatusState, summaryPos, hass, routerEnabled, primaryApItem, topology.branchColumns.length > 0, switchConfig, switchEnabled, switchEntityState, switchDevicesState, switchOfflineTop, switchDur);
    }
    _renderBranchesSection(config, hass, topology) {
        const branchColumns = topology.branchColumns || [];
        ...
        const primaryApOfflineColor = primaryApItem
            ...
            : "";
        return this._renderBranches(branchColumns, animate, config.flow_line_color || "var(--divider-color, #ccc)", !!(config.individual_devices && config.individual_devices.length), config.flow_line_color || "var(--divider-color, #ccc)", hass, primaryApItem ? primaryApOffline : (switchEnabled ? (routerOfflineTop || switchOfflineTop) : routerOfflineTop), primaryApItem ? primaryApOfflineColor : (switchEnabled ? switchOfflineColor : routerOfflineColor), primaryApItem ? true : (routerEnabled || switchEnabled), primaryApItem, topology.primaryApLayout, minDur, maxDur, topology.primaryOriginalIndex);
    }
    _renderClientsSection(config, hass, branchCount) {
        return this._renderIndividualDevices(config.individual_devices, hass, config, config.enable_animations === true, config.min_flow_duration ?? 0.6, config.max_flow_duration ?? 6, branchCount);
    }
    render() {
        ...
        const topology = this._topology || buildNetworkTopology(config);
        const summaryPos = config.summary_position || "top";
        const updateTrunk = this._dirtyTrunk || !this._hasRenderedTrunk;
        const updateBranches = this._dirtyBranches || !this._hasRenderedBranches;
        const updateClients = this._dirtyClients || !this._hasRenderedClients;
        const summaryTemplate = updateTrunk
            ? this._renderSummarySection(config, hass)
            : LIT_NO_CHANGE;
        const trunkTemplate = updateTrunk
            ? this._renderTrunkSection(config, hass, topology)
            : LIT_NO_CHANGE;
        const branchesTemplate = updateBranches
            ? this._renderBranchesSection(config, hass, topology)
            : LIT_NO_CHANGE;
        const clientsTemplate = updateClients
            ? this._renderClientsSection(config, hass, topology.branchColumns.length)
            : LIT_NO_CHANGE;
        this._dirtyTrunk = false;
        this._dirtyBranches = false;
        this._dirtyClients = false;
        this._hasRenderedTrunk = true;
        this._hasRenderedBranches = true;
        this._hasRenderedClients = true;
        return b `
      <ha-card>
        ${config.title ? b `<h1 class="card-header">${config.title}</h1>` : null}
    ...
    _getGroupedIndividualDevices(hass, devices, groupBy) {
        const stateObjs = devices.map((dev) => hass?.states?.[dev.entity] || null);
        const cached = this._clientGroupCache;
        if (cached &&
        ...
        const groups = groupIndividualDevices(hass, devices, groupBy);
        this._clientGroupCache = { devices, groupBy, stateObjs, groups };
        return groups;
    }
    _renderIndividualDevices(devices, hass, config, animate, minDur, maxDur, apCount) {
        ...
        const groups = groupBy !== "none" ? this._getGroupedIndividualDevices(hass, devices, groupBy) : null;
        ...
        <div class="individual-devices-box" style="${groups ? 'padding:8px;' : ''}">
          ...
          ${groups
            ? b `
                ...
                const colorOverride = (config.individual_devices_group_colors || []).find((o) => o.name === group.name);
                const groupBorderColor = colorOverride?.color || config.individual_devices_group_border_color || boxColor;
                const flexStyle = groupLayout === "widest_fits"
    ...
    _backhaulBadge(ap, hass) {
        if (ap.show_backhaul_icon === false)
            return null;
        const entityId = ap.entities?.backhaul_type;
        const hasEntity = !!entityId && !!hass?.states?.[entityId];
        if (!hasEntity && !ap.is_primary)
            return null;
        const wired = isBackhaulWired(hass, ap);
        const icon = wired ? "mdi:ethernet" : "mdi:wifi";
    ...
    _renderXOnlyVertical(height = 32) {
      ...
      <div class="vline-pair" style="height:${height}px; justify-content:center;">
        <div class="offline-x-mid ${this._config.enable_animations === true ? "offline-x-pulse" : ""}" style="color:var(--error-color, #f44336)">
    ...
    _verticalDualLine(c1, c2, d1, d2, animate, height = 32, dashed = false) {
        const strandStyle = (color, left) => dashed
    ...
    _cssDotsY(color, duration, posX, reverse, count = 3) {
        ...
        return Array.from({ length: count }).map((_, i) => b `
        <div
    ...
    _renderTrunk(internet, internetState, lan, lanState, lanDur, pingState, hasBilling, completedRatio, dlDur, ulDur, animate, router, routerEntityState, routerStatus, summaryPos, hass, routerEnabled, primaryApItem, hasOtherAps, switchConfig, switchEnabled, switchEntityState, switchDevicesState, switchOfflineTop, switchDur) {
        ...
        const primaryApOffline = primaryApItem
            ? isEntityUnavailable(hass, primaryApItem.ap.entity)
            : false;
        const beforePrimaryOffline = (routerEnabled ? routerOffline : internetOffline) || (switchEnabled && switchOfflineTop);
      ...
      <div class="trunk">
        <div class="internet-row pos-${summaryPos}">
          ...
          >
            <div
              class="circle ${internetOffline && animate ? "circle-pulse" : ""}"
            ...
            >
              <ha-icon class="${internetOffline && animate ? "icon-pulse" : ""}" .icon=${internetOffline ? "mdi:exclamation-thick" : (internet.icon || "mdi:web")} style="color:${internetIconColor};--mdc-icon-size:${internet.icon_size ?? 24}px"></ha-icon>
              <span class="circle-value">${internetLabel}</span>
            </div>
            ${hasBilling && !internetOffline
            ? this._ring(completedPct, remainingPct, internet.colors.billing_remaining, internet.colors.billing_progress, internet.entities.billing_remaining)
            : null}
        ...
        ${internetOrRouterOffline
            ...
            : internetHasBandwidth
                ? this._verticalDualLine(internet.colors.download, internet.colors.upload, dlDur, ulDur, animate)
                : this._verticalSingleLine(internet.colors.download, dlDur, animate, 32)}
        ...
        >
          <div class="circle ${routerOffline && animate ? "circle-pulse" : ""}" style="border-color:${routerCircleColor}; opacity:${routerOffline ? 0.6 : 1}; --pulse-color:${routerCircleColor};">
            <ha-icon class="${routerOffline && animate ? "icon-pulse" : ""}" .icon=${routerOffline ? "mdi:exclamation-thick" : (router.icon || "mdi:router-network")} style="color:${routerIconColor};--mdc-icon-size:${router.icon_size ?? 24}px"></ha-icon>
          ...
          ${lan.entity
                ...
                <div class="lan-branch ${summaryPos === "right" ? "flip-left" : ""}">
                  ...
                  >
                    <div class="circle ${lanOffline && animate ? "circle-pulse" : ""}" style="border-color:${lanCircleColor}; --pulse-color:${lanCircleColor};">
                      <ha-icon class="${lanOffline && animate ? "icon-pulse" : ""}" .icon=${lanOffline ? "mdi:exclamation-thick" : (lan.icon || "mdi:lan")} style="color:${lanIconColor};--mdc-icon-size:${lan.icon_size ?? 20}px"></ha-icon>
                      <span class="circle-value">
        ...
        ${switchEnabled
            ? b `
              ${(routerEnabled ? routerOffline : internetOffline) || switchOfflineTop
                ...
                : this._verticalSingleLine(this._config.flow_line_color || "var(--divider-color, #ccc)", switchDur, animate, 28)}
              <div
                class="circle-wrap"
              ...
              >
                <div class="circle ${switchOfflineTop && animate ? "circle-pulse" : ""}" style="border-color:${switchCircleColor}; --pulse-color:${switchCircleColor};">
                  <ha-icon class="${switchOfflineTop && animate ? "icon-pulse" : ""}" .icon=${switchOfflineTop ? "mdi:exclamation-thick" : (switchConfig.icon || "mdi:switch")} style="color:${switchIconColor};--mdc-icon-size:${switchConfig.icon_size ?? 22}px"></ha-icon>
                ...
                ? (() => {
                    ...
                    return b `
                        ...
                        this._handleMoreInfo(switchConfig.entities.connected_devices);
                          ...
                          >
                            <div class="circle ${swDevOffline && animate ? "circle-pulse" : ""}" style="border-color:${swDevCircleColor}; --pulse-color:${swDevCircleColor};">
                              <ha-icon class="${swDevOffline && animate ? "icon-pulse" : ""}" .icon=${swDevOffline ? "mdi:exclamation-thick" : (switchConfig.devices_icon || "mdi:devices")} style="color:${swDevIconColor};--mdc-icon-size:${this._config.ap_devices_icon_size ?? 20}px"></ha-icon>
        ...
        ${primaryApItem
            ? b `
              ${(() => {
                ...
                if (!routerEnabled && !switchEnabled)
                    return null;
                if (primaryLineOffline)
                    return this._renderXOnlyVertical(lineHeight);
                if (primaryApHasBandwidth) {
                    return this._verticalDualLine(this._config.flow_line_color || "var(--divider-color, #ccc)", this._config.flow_line_color || "var(--divider-color, #ccc)", primaryApItem.dlDur, primaryApItem.ulDur, animate, lineHeight);
                }
                return this._verticalSingleLine(this._config.flow_line_color || "var(--divider-color, #ccc)", primaryApItem.dlDur, animate, lineHeight);
            })()}
              <div
                class="circle-wrap"
              ...
              >
                <div
                  class="circle ${primaryApOffline && animate ? "circle-pulse" : ""}"
                  style="border-color:${primaryApCircleColor}; --pulse-color:${primaryApCircleColor};"
                >
                  <ha-icon
                    class="${primaryApOffline && animate ? "icon-pulse" : ""}"
              ...
              ${!hasOtherAps && primaryApItem.hasDevices
                ? (() => {
                    const devOffline = primaryApOffline ||
                    ...
                    return b `
                      ${this._verticalSingleLine(this._config.flow_line_color || "var(--divider-color, #ccc)", primaryApItem.devDur, animate, 24, true)}
                      <div
                        class="circle-wrap"
                        style="width:${devCircleSize}px; height:${devCircleSize}px; opacity:${devOffline ? 0.6 : 1};"
                        @click=${() => this._handleMoreInfo(primaryApItem.ap.entities.connected_devices)}
                      >
                        <div
                          class="circle ${devOffline && animate ? "circle-pulse" : ""}"
                          style="border-color:${devCircleColor}; --pulse-color:${devCircleColor};"
                        >
                          <ha-icon
                            class="${devOffline && animate ? "icon-pulse" : ""}"
    ...
    _renderBranches(columns, animate, busLineColor, hasIndividualDevices, individualDevicesLineColor, hass, routerOffline, routerOfflineColor, routerEnabled, primaryApItem, primaryApLayout, minDur, maxDur, primaryOriginalIndex = -1) {
        ...
        if (hasAnyAp)
            circleSizeCandidates.push(this._config.ap_circle_size ?? 72);
        if (hasAnySwitch)
            circleSizeCandidates.push(this._config.switch?.circle_size ?? 60);
        if (hasAnyDevices)
            circleSizeCandidates.push(this._config.ap_devices_circle_size ?? 56);
      ...
      >
        ${collapseTbar
            ...
            `
              ...
              <div class="trunk-drop" style="${trunkDropStyle} display:flex; justify-content:center; align-items:center;">
                <div class="offline-x-mid ${animate ? "offline-x-pulse" : ""}" style="color:var(--error-color, #f44336)">
                  <ha-icon icon="mdi:close"></ha-icon>
                </div>
              </div>
              <div class="bus-line" style="${busLineStyle}"></div>
        ...
        ${!hasAnySwitch ? null : columns.map((col, i) => {
              ...
              <div class="ap-col-line bus-top-connector" style="grid-column:${apCol(i)}; grid-row:3;">
                ${hideApOwnLine || routerOffline
                    ...
                    : columnLineInfo[i].hasBandwidth
                        ? this._verticalDualLine(busLineColor, busLineColor, columnLineInfo[i].dlDur, columnLineInfo[i].ulDur, animate, "100%", !columnWired[i])
                        : this._verticalPassThroughLine(busLineColor, columnDurations[i], animate, !columnWired[i])}
              </div>
            `;
            }
            if (!col.switchGroupStart)
                return null;
            ...
            >
              <div class="circle ${(swOffline || routerOffline) && animate ? "circle-pulse" : ""}" style="border-color:${swColor}; --pulse-color:${swColor};">
                <ha-icon class="${(swOffline || routerOffline) && animate ? "icon-pulse" : ""}" .icon=${(swOffline || routerOffline) ? "mdi:exclamation-thick" : (col.switch.icon || defaultIcon)} style="color:${swIconColor};--mdc-icon-size:${swIconSize}px"></ha-icon>
        ...
        ${!hasApRow ? null : columns.map((col, i) => {
            ...
            const apDlState = columnViewModels[i].dlState;
            const apUlState = columnViewModels[i].ulState;
              ...
              ${hideApOwnLine
                ...
                : apLineOffline
                    ...
                    : col.switch
                        ? this._verticalSingleLine(busLineColor, 3, animate, "100%", false)
                        : apHasBandwidth
                            ? this._verticalDualLine(busLineColor, busLineColor, apDlDur, apUlDur, animate, "100%", !apWired)
                            : this._verticalSingleLine(busLineColor, apDlDur, animate, "100%", !apWired)}
        ...
        ${!hasApRow ? null : columns.map((col, i) => {
            if (col.subSwitch) {
              ...
              >
                <div class="circle ${subOffline && animate ? "circle-pulse" : ""}" style="border-color:${subColor}; --pulse-color:${subColor};">
                  <ha-icon class="${subOffline && animate ? "icon-pulse" : ""}" .icon=${subOffline ? "mdi:exclamation-thick" : (col.subSwitch.icon || "mdi:switch")} style="color:${subIconColor};--mdc-icon-size:${subIconSize}px"></ha-icon>
            ...
            >
              <div class="circle ${apOffline && animate ? "circle-pulse" : ""}" style="border-color:${apCircleColor}; --pulse-color:${apCircleColor};">
                <ha-icon class="${apOffline && animate ? "icon-pulse" : ""}" .icon=${apOffline ? "mdi:exclamation-thick" : (col.ap.icon || "mdi:wifi")} style="color:${apIconColor};--mdc-icon-size:${this._config.ap_icon_size ?? 24}px"></ha-icon>
    ...
    static get styles() {
      ...
      :host([animations-disabled]) .flow-dot,
      :host([animations-disabled]) .vpn-badge-flash,
      :host([animations-disabled]) .firewall-badge-flash,
      :host([animations-disabled]) .poe-badge-flash,
      :host([animations-disabled]) .icon-pulse,
      :host([animations-disabled]) .offline-x-pulse,
      :host([animations-disabled]) .circle-pulse {
        animation: none !important;
      }
      /* Keep the last visual frame but stop compositor work while the card
         is outside the active viewport/dashboard. */
      :host([data-offscreen]) .flow-dot,
      :host([data-offscreen]) .vpn-badge-flash,
      :host([data-offscreen]) .firewall-badge-flash,
      :host([data-offscreen]) .poe-badge-flash,
      :host([data-offscreen]) .icon-pulse,
      :host([data-offscreen]) .offline-x-pulse,
      :host([data-offscreen]) .circle-pulse {
...
class NetworkFlowCardEditor extends i {
    ...
    shouldUpdate(changedProps) {
        ...
        if (!oldHass || !this.hass)
            return true;
        return (oldHass.entities !== this.hass.entities ||
    ...
    constructor() {
        super();
        this._page = null;
        this._discoverHomelabNodeIndex = -1;
    ...
    setConfig(config) {
        ...
        merged.individual_devices = (config && config.individual_devices || []).map((dev) => deepMerge(DEFAULT_INDIVIDUAL_DEVICE, dev));
        this._config = merged;
    }
    _fireChanged() {
                    ...
                    return thresholds.map((t, i) => {
                        ...
                        <div class="two-col">
                          ${isCatchAll
                            ...
                            : this._renderInput(`Up to (${p.unit || "W"})`, t.up_to, `${path}.thresholds.${i}.up_to`, "number")}
    ...
    _scanEverything() {
        ...
        this._discoverHomelabNodeIndex = homelabIndex;
        if (homelabIndex !== -1) {
    ...
    _renderDiscoverPage() {
        ...
        const homelabIndex = this._discoverHomelabNodeIndex ?? -1;
    ...
    _renderRouterPage() {
      ...
      <div class="form-section">
        ...
        <p style="color:var(--secondary-text-color); font-size:0.9em; margin:0 0 8px 0;">
          ...
          device from the TP-Link Router integration, an OpenWrt router
          via the LuCI integration, a Synology SRM router, and an
          AsusRouter/AiMesh router - if more than one exists (e.g. a
          TP-Link Router acting as your modem/gateway with a Deco mesh
          riding behind it), you choose which one is the Router below
          rather than having one picked for you. Neither LuCI nor
          Synology SRM has a dedicated router-status entity of its own,
          so both candidates use one of their client-tracker entities
          as a reachability proxy instead - don't be surprised by the
          entity name. LuCI's proxy reliably goes unavailable when the
          router drops offline; Synology SRM's is best-effort only,
          since that integration's older polling model doesn't
          guarantee the same. AsusRouter has a real connectivity sensor
          for its main AiMesh unit, so its candidate is as reliable as
          TP-Link's.
        </p>
            ...
            ? (() => {
                ...
                return thresholds.map((t, i) => {
                  ...
                  <div class="two-col">
                    ${isCatchAll
                        ? b `<span style="color:var(--secondary-text-color); align-self:center;">Above previous</span>`
                        : this._renderInput(`Up to${this._config.dns_unit ? ` (${this._config.dns_unit})` : ""}`, t.up_to, `dns_thresholds.${i}.up_to`, "number")}
    ...
    _renderAccessPointsPage() {
      ...
      <div class="form-section">
        ...
        <div class="sub-header">Auto-Discovery</div>
        <p style="color:var(--secondary-text-color); font-size:0.9em; margin:0 0 8px 0;">
          Scans TP-Link Deco (satellite units, added as Access Point
          nodes), Proxmox VE (physical/cluster nodes, added as Homelab
          Server nodes with their VMs/Containers attached
          automatically), and AsusRouter AiMesh (satellite units, added
          as Access Point nodes) in one pass. Nothing is added
          automatically; filter and select which ones you want below.
        </p>
    ...
    _addSelectedContainers(nodeIndex) {
        const existing = this._existingContainerEntities();
        const toAdd = (this._discoveredContainers || []).filter((c) => this._discoveredContainersSelected.has(c.entity) && !existing.has(c.entity));
        if (!toAdd.length)
            return;
        const nodes = [...(this._config.nodes || [])];
        const node = nodes[nodeIndex];
      ...
      ${sources.length > 1
            ...
            <div class="toggle-row">
              ...
              >
                ...
                ${sources.map((s) => b `<option value=${s}>${sourceLabel[s] || s} (${all.filter((c) => c.source === s).length})</option>`)}
              </select>
            </div>
          `
            : null}
    ...
    _renderHomelabFields(index, node) {
      ...
      <div class="sub-header">Auto-Discovery (Container/VM)</div>
      <p style="color:var(--secondary-text-color); font-size:0.9em; margin:0 0 8px 0;">
        Scans Portainer (Docker containers) and Proxmox VE (VMs and
        LXC containers) together and lets you add the ones you want as
        badges on this node. Already-added containers/VMs (on this
        node or any other) show a Remove button instead.
      </p>
      <button class="add-btn" @click=${() => this._scanForContainers()}>
        Scan for Container/VM
      </button>
    ...
    _removeSpeedtestSelection(svc) {
        ...
        if (svc.ping && entities.ping === svc.ping)
            entities.ping = "";
        if (svc.jitter && entities.jitter === svc.jitter)
            entities.jitter = "";
        if (svc.download && entities.download === svc.download)
            entities.download = "";
        if (svc.upload && entities.upload === svc.upload)
            entities.upload = "";
    ...
    _removeIspSelection(svc) {
        ...
        if (svc.connected && entity === svc.connected)
            entity = "";
        if (svc.billingTotal && entities.billing_total === svc.billingTotal)
            entities.billing_total = "";
        if (svc.billingRemaining && entities.billing_remaining === svc.billingRemaining)
            entities.billing_remaining = "";
        if (svc.totalDownload && entities.total_download === svc.totalDownload)
            entities.total_download = "";
        if (svc.totalUpload && entities.total_upload === svc.totalUpload)
            entities.total_upload = "";
    ...
    _scanForRouter() {
        ...
        if (openwrtResult.routerCandidate)
            candidates.push(openwrtResult.routerCandidate);
        if (srmResult.routerCandidate)
            candidates.push(srmResult.routerCandidate);
        if (asusResult.routerCandidate)
            candidates.push(asusResult.routerCandidate);
    ...
    _removeRouterSelection(candidate) {
        ...
        if (router.entity === candidate.entity)
            router.entity = "";
        if (candidate.wanIpEntity && router.entities.wan_ip === candidate.wanIpEntity)
            router.entities.wan_ip = "";
        if (candidate.lanIpEntity && router.entities.lan_ip === candidate.lanIpEntity)
            router.entities.lan_ip = "";
        const newLan = { ...lan };
        if (candidate.lanEntity && newLan.entity === candidate.lanEntity)
            newLan.entity = "";
    ...
    _removeAllNodes() {
        ...
        if (!count)
            return;
        if (!window.confirm(`Remove all ${count} node${count === 1 ? "" : "s"}? This can't be undone.`))
            return;
        this._config = { ...this._config, nodes: [] };
    ...
    _removeAllContainers(nodeIndex) {
        ...
        if (!count)
            return;
        if (!window.confirm(`Remove all ${count} container${count === 1 ? "" : "s"}/VM(s) from this node? This can't be undone.`))
            return;
    ...
    _removeAllRouter() {
        const router = this._config.router || {};
        if (!router.entity && !router.entities?.wan_ip && !router.entities?.lan_ip)
            return;
        if (!window.confirm("Remove the Router entity and its WAN/LAN IP fields? This can't be undone."))
            return;
        const lan = this._config.lan || {};
        this._config = {
            ...this._config,
    ...
    _removeAllSpeedtest() {
        ...
        if (!e.ping && !e.jitter && !e.download && !e.upload)
            return;
        if (!window.confirm("Remove all Speedtest fields (Ping, Jitter, Download, Upload)? This can't be undone."))
            return;
        this._config = {
            ...this._config,
    ...
    _removeAllIsp() {
        const internet = this._config.internet || {};
        const e = internet.entities || {};
        if (!e.billing_total && !e.billing_remaining && !e.total_download && !e.total_upload)
            return;
        if (!window.confirm("Remove all ISP fields (Billing Total, Billing Remaining, Total Downloaded, Total Uploaded)? This can't be undone."))
            return;
        this._config = {
            ...this._config,
    ...
    _removeAllAdGuard() {
        if (!this._config.dns_entity)
            return;
        if (!window.confirm("Remove the DNS Filtering entity? This can't be undone."))
            return;
        this._config = { ...this._config, dns_entity: "" };
        this._adguardScanMessage = "DNS Filtering entity removed.";
        this._fireChanged();
    ...
    _existingNodeEntities() {
        ...
        (this._config.nodes || []).forEach((n) => {
            ...
            if (n.homelab?.entity)
                existing.add(n.homelab.entity);
        });
        if (this._config.router?.entity)
            existing.add(this._config.router.entity);
        return existing;
    }
    ...
    _visibleNodeCandidates() {
        ...
        return all.filter((c) => (!activeSource || c.source === activeSource) && (!activeType || c.type === activeType));
    }
    ...
    _addSelectedNodes() {
        const existing = this._existingNodeEntities();
        const toAdd = (this._discoveredNodes || []).filter((c) => this._discoveredNodesSelected.has(c.entity) && !existing.has(c.entity));
        if (!toAdd.length)
            return;
        const newNodes = toAdd.map((c) => {
            if (c.type === "homelab") {
                const n = c.raw;
                return {
                    ...DEFAULT_NODE,
        ...
        this._nodeScanMessage = `Added ${newNodes.length} node${newNodes.length === 1 ? "" : "s"}: ${newNodes
            .map((n) => n.name || n.homelab?.entity || n.access_points[0]?.entity)
            .join(", ")}`;
        this._fireChanged();
    }
    ...
    _renderDiscoveredNodesList() {
        ...
        const all = this._discoveredNodes || [];
        if (!all.length) {
            return b `<p style="color:var(--secondary-text-color); font-size:0.9em; margin:0 0 12px;">No matching TP-Link Deco units or Proxmox VE nodes found.</p>`;
        }
        const sourceLabel = { tplink_deco: "TP-Link Deco", proxmoxve: "Proxmox VE", asusrouter: "AsusRouter (AiMesh)" };
      ...
      <div style="display:flex; gap:8px; flex-wrap:wrap; margin-bottom:8px;">
        ...
        >
          ...
          ${types.map((t) => b `<option value=${t}>${typeLabel[t] || t} (${all.filter((c) => c.type === t).length})</option>`)}
        </select>
      </div>
      ...
      ${pageItems.map((c) => {
            ...
            const icon = c.type === "homelab" ? "mdi:server" : "mdi:wifi";
            return b `
          <div class="list-item" style="opacity:1">
            <div class="list-item-info">
    ...
    _renderDiscoveredDevicesList() {
      ...
      ${sources.length > 1
            ...
            <div class="toggle-row">
              ...
              >
                <option value="">All (${all.length})</option>
                ${sources.map((s) => b `<option value=${s}>${sourceLabel[s] || s} (${all.filter((d) => d.source === s).length})</option>`)}
              </select>
            </div>
          `
            : null}
    ...
    _renderIndividualDevicesPage() {
      ...
      <div class="form-section">
        ...
        ${this._renderColorInput("Box Border Color", this._config.individual_devices_box_color, "individual_devices_box_color")}
        ${this._renderInput("Box Border Radius", this._config.individual_devices_box_radius, "individual_devices_box_radius")}
        ...
        ${this._config.individual_devices_group_by && this._config.individual_devices_group_by !== "none"
            ? b `
              ...
              ${this._renderInput("Group Box Border Radius", this._config.individual_devices_group_box_radius, "individual_devices_group_box_radius")}
              ...
              ${this._config.individual_devices_group_show_border !== false
                ? b `
                    ${this._renderColorInput("Default Sub-Group Outline Color", this._config.individual_devices_group_border_color, "individual_devices_group_border_color")}
        ...
        ></ha-icon-picker>
        ${this._renderColorInput("Icon Color", this._config.individual_device_guest_icon_color, "individual_device_guest_icon_color")}
        ${this._renderColorInput("Badge Background Color", this._config.individual_device_guest_icon_bg, "individual_device_guest_icon_bg")}
        ...
        <p style="color:var(--secondary-text-color); font-size:0.9em; margin:0 0 8px 0;">
          ...
          TP-Link Router, OpenWrt (LuCI), Synology SRM, and AsusRouter
    ...
    _deleteAllDevices() {
        ...
        if (!count)
            return;
        if (!window.confirm(`Delete all ${count} client${count === 1 ? "" : "s"}? This can't be undone.`))
            return;
    ...
    _moveDev(idx, direction) {
        const devs = [...(this._config.individual_devices || [])];
        const newIdx = idx + direction;
        if (newIdx < 0 || newIdx >= devs.length)
            return;
                        ...
                        return thresholds.map((t, i) => {
                            ...
                            return b `
                              <div class="two-col">
                                ${isCatchAll
                                ? b `<span style="color:var(--secondary-text-color); align-self:center;">Above previous</span>`
                                : this._renderInput("Up to (W)", t.up_to, `summary_poe_thresholds.${i}.up_to`, "number")}
                                ${this._renderColorInput("Color", t.color, `summary_poe_thresholds.${i}.color`)}
                              </div>
                            `;
                        });
                    })()
                    : this._renderColorInput("Badge Color", this._config.summary_poe_color, "summary_poe_color")}
                  `
                : null}
            `
            : null}
