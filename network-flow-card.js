            ...
            return html`
              <div class="ap-col-line bus-top-connector" style="grid-column:${apCol(i)}; grid-row:3;">
                ${hideApOwnLine || routerOffline
                  ? null
                  : this._verticalPassThroughLine(busLineColor, 3, animate)}
              </div>
            `;
          }
          ...
          if (!col.ap) {
            ...
            return html`
              <div class="ap-col-line" style="grid-column:${apCol(i)}; grid-row:5;">
                ${feederOffline ? null : this._verticalPassThroughLine(col.switch?.colors?.bus_line || busLineColor, 3, animate)}
              </div>
            `;
          }
          ...
          if (col.switch && col.switchGroupSize > 1 && col.switchGroupStart) {
            ...
            return html`
              ...
              <div class="ap-col-line ap-col-line-grouped" style="grid-column:${apCol(i)}; grid-row:5;">
                ${apLineOffline ? this._renderXOnlyVertical(24) : this._verticalSingleLine(col.switch.colors?.bus_line || busLineColor, 3, animate, 24, false)}
              </div>
            `;
          }
          if (col.switch && col.switchGroupSize > 1 && !col.switchGroupStart) {
