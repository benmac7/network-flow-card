    ...
    return html`
      ...
      >
        ...
        ${!hasAnySwitch ? null : columns.map((col, i) => {
          ...
          if (!col.switch) {
            return html`
              <div class="ap-col-line" style="grid-column:${apCol(i)}; grid-row:3;">
          ...
          return html`
            <div class="ap-col-line" style="grid-column:${apCol(i)} / span ${colSpan}; grid-row:3;">
              ${routerOffline
                ? null
        ...
        ${!hasAnyAp ? null : columns.map((col, i) => {
          ...
          if (col.switch && col.switchGroupSize > 1 && col.switchGroupStart) {
            ...
            // mini bus-line spanning the whole group, plus this
            // column's own drop into its AP circle.
            const colSpan = col.switchGroupSize;
            return html`
              <div class="mini-bus-line" style="grid-column:${apCol(i)} / span ${colSpan}; grid-row:5; background:${col.switch.colors?.bus_line || busLineColor};"></div>
