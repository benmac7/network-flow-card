/**
 * NETWORK-FLOW-CARD v1.3.0-beta.1
...
console.info(
  "%c NETWORK-FLOW-CARD %c v1.3.0-beta.1 ",
...
class NetworkFlowCard extends LitElement {
  ...
  _renderBranches(apData, animate, busLineColor, hasIndividualDevices, individualDevicesLineColor, hass, routerOffline, routerOfflineColor, routerEnabled, primaryApItem) {
    const count = apData.length;
    const primaryHasDevices = !!(primaryApItem && primaryApItem.hasDevices);
    const extraCol = primaryHasDevices ? count + 1 : null;
