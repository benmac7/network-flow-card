...
class NetworkFlowCard extends LitElement {
  ...
  _alignBusLine() {
    ...
    const leftMargin = Math.max(0, leftMostRect.left + leftMostRect.width / 2 - branchesRect.left);
    const rightMargin = Math.max(0, branchesRect.right - (rightMostRect.left + rightMostRect.width / 2));
